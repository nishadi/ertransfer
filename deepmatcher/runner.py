...
class Runner(object):
    ...
    def _run(run_type,
        ...
        for batch_idx, batch in enumerate(run_iter):
            ...
            output, domain_output = model(batch)
            ...
            if criterion:
                ...
                # Source domain is considered as 0s
                domain_label = torch.zeros(len(batch.id))
                domain_label = domain_label.long()
                # Loss of the domain classification
            ...
            if train:
                ...
                model.zero_grad()
                total_loss = loss + loss_s_domain + loss_t_domain
                total_loss.backward()
